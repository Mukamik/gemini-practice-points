...
public class AuthorControllerTests {
    ...
    void addAuthorShouldReturnAuthor() {
        ...
        this.graphQlTester.document(document)
                .variable("input", new HashMap<String, Object>() {{
                    put("firstname", input.firstname());
                    put("surname", input.surname());
                    put("surname2", input.surname2());
                }})
                .execute()
    ...
    void updateAuthorShouldReturnUpdatedAuthor() {
        ...
        this.graphQlTester.document(document)
                ...
                .variable("input", Map.of(
                        ...
                        // Ensure all fields defined in AuthorInput for the mutation are present
                ))
                .execute()
    ...
    void getAuthorsShouldReturnListOfAuthors() {
        ...
        // Corrected mock: when filtering by surname "Doe", firstname will be null
